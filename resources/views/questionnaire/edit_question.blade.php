            ...
            <form action="{{ url('question/'. $question->id) }}" method="post">
                ...
                <div class="card">
                    <div class="card-header py-3">
                        <h5 class="mb-0 text-center"><strong>Update Pertanyaan</strong></h5>
                    </div>
                    <div class="card-body">
                        <label>Judul Pertanyaan</label></br>
                        <input type="text" name="judul_pertanyaan" value="{{$question->judul_pertanyaan}}" id="judul_pertanyaan" class="form-control"></br>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div id="inputFormRow">
                                    <div class="input-group mb-3">
                                        <input type="text" name="questions[]" class="form-control m-input" value="{{$quest->pertanyaan}}" autocomplete="off">
