...
<section class="mb-4">
  <div class="card">
    <div class="card-header py-3">
      <h5 class="mb-0 text-center"><strong>Update Data Alumni</strong></h5>
    </div>
    <div class="card-body">

      <form action="{{ url('data/' . $alumni->id) }}" method="post">
        {!! csrf_field() !!}
        @method("PATCH")
        <input type="hidden" name="id" id="id" value="{{$alumni->id}}" id="id" />
        <label>Nama</label></br>
        <input type="text" name="name" id="name" value="{{$alumni->name}}" class="form-control"></br>
        <label>Nomor Induk Mahasiswa</label></br>
        <input type="text" name="nim" id="nim" value="{{$alumni->nim}}" class="form-control"></br>
        <label>Angkatan</label></br>
        <select class="form-control" name="angkatan">
          <option value="{{$alumni->angkatan}}" selected>{{$alumni->angkatan}}</option>
        ...
        <input type="text" name="prodi" id="prodi" class="form-control" value="{{$alumni->prodi}}"></br>
        <label>Nomor Telepon</label></br>
        <input type="text" name="telepon" id="telepon" class="form-control" value="{{$alumni->telepon}}"></br>
        ...
        <select class="form-control" name="tempat_kerja">
          <option value="{{$alumni->tempat_kerja}}" selected>{{Str::upper($alumni->tempat_kerja)}}</option>
          <option value="Aceh">
            ACEH
          </option>
